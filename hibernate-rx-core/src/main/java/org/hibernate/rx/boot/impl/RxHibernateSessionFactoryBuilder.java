...
public class RxHibernateSessionFactoryBuilder
	...
	public RxHibernateSessionFactory build() {
		...
		BootstrapContext bootstrapContext = new BootstrapContextImpl( options.getServiceRegistry(), null, metadata.getMetadataBuildingOptions() ); // Not sure I should initialize this
		return new RxHibernateSessionFactoryImpl( new SessionFactoryImpl( bootstrapContext, metadata, options ) );
	}
}
